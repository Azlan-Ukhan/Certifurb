...
import { FaChevronLeft, FaChevronRight, FaRegHeart, FaTimes, FaExclamationTriangle } from 'react-icons/fa'
                ...
                <div className="absolute z-10 w-full bg-white border border-gray-300 rounded-lg max-h-48 overflow-y-auto shadow-lg">
                  {getFilteredProducts(searchTerm1, selectedProduct2).map((product) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-500">{product.ProductCategory} - {formatPrice(product.ProductPrice)}</div>
                    </div>
                  ))}
            ...
            <div className="flex justify-center mb-6">
              {selectedProduct1 ? (
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-green-600 mt-2">{formatPrice(selectedProduct1.ProductPrice)}</div>
                </div>
              ) : (
            ...
            <div className="flex justify-center mb-6">
              {selectedProduct2 ? (
                <div className="text-center">
                  ...
                  <div className="text-lg font-bold text-green-600 mt-2">{formatPrice(selectedProduct2.ProductPrice)}</div>
                </div>
              ) : (
                <div className="h-44 flex items-center justify-center text-gray-400">
                  <div className="text-center">
            ...
            <div className="flex gap-4 overflow-hidden justify-center">
              {filteredProducts.slice(carouselIndex, carouselIndex + visibleCount).map((product) => (
                <div key={product.ProductID} className="bg-white rounded-xl border border-gray-300 p-6 relative flex flex-col min-w-[220px] max-w-[250px] w-[210px] h-full shadow-sm">
                  ...
                  <p className="text-md font-bold text-black mt-auto">{formatPrice(product.ProductPrice)}</p>
                </div>
              ))}
            </div>
            <button 
