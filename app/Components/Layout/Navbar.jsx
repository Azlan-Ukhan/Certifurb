  ...
  return (
    <div className={`${font.className} relative`}>
      ...
      <div className='bg-white w-full flex justify-between items-center p-4 md:p-6 lg:p-8 px-4 md:px-6 lg:px-8 relative'>
        ...
        <div className='hidden lg:flex items-center mr-8 justify-center space-x-4 text-xl'>
          {/* GOAT Icon */}
          <Link href="/category?filter=GOAT Product">
      ...
      <div className='hidden lg:flex space-x-[33px] font-bold pt-3 pb-3 justify-center items-center'>
        ...
        >
          ...
          {isLaptopDropdownOpen && (
            <div className='absolute top-full left-0 mt-1 w-40 bg-white rounded-lg shadow-lg border border-gray-200 z-50'>
              <div className='py-1'>
                <Link href="/category?filter=Laptop&brand=Acer">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    Acer
                  </div>
                </Link>
                <Link href="/category?filter=Laptop&brand=Asus">
                  <div className='px-4 py-2 hover:bg-gray-100 cursor-pointer text-sm font-medium'>
                    Asus
                  </div>
                </Link>
        ...
        <Link href={"/category"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Help</p></Link>
        <Link href={"/category"}><p className='cursor-pointer hover:text-gray-600 transition-colors'>Become A Seller</p></Link>
      </div>
