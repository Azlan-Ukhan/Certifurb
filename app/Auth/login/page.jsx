              ...
              <div className="w-full relative">
                {googleReady ? (
                  <>
                    ...
                    <div id="google-signin-button" className="absolute opacity-0 pointer-events-none"></div>
                    
                    {/* Custom styled button */}
                    <button 
                      onClick={() => {
                        // Trigger the hidden Google button
                        const googleBtn = document.querySelector('#google-signin-button [role="button"]');
                        if (googleBtn) {
                          googleBtn.click();
                        }
                      }}
                      className="w-full border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg transition duration-200 flex items-center justify-center gap-2"
                    >
