      ...
      <div className={`${font.className} p-6 bg-gray-50 min-h-screen`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Organize</h3>
              
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="text-sm font-medium text-gray-700">Category</label>
                    <button className="text-xs text-blue-600 hover:underline">Add new category</button>
                  </div>
                  <div className="relative">
                    <select
                      value={category}
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="text-xs text-blue-600 hover:underline">Add new vendor</button>
                  </div>
                  <div className="relative">
                    <select
                      value={vendor}
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button className="text-xs text-blue-600 hover:underline">View all tags</button>
                  </div>
                  <div className="relative">
                    <select
                      value={tags}
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4 min-h-16 bg-gray-50">
                  <p className="text-sm text-gray-500">Add variant values</p>
                </div>
              </div>
            </div>
          </div>
